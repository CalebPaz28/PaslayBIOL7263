...
##### About me
Hello! I am a current master's degree student with Dr. Ali. I have been happily married to my beautiful wife B for over 3 years now. We also have an amazing daughter, R, whom we welcomed into this world in March of 2022. We have two doggie friends, Koda and Hazel (Figure 1). 
...
```{r, echo=FALSE, out.width="50%", fig.cap="Figure 3 Pepper Cultivars",fig.align='center',R.options="angle=90"}
knitr::include_graphics("8.19.22 All (1).JPEG")
```

##### Table of Assignments
Date|Description|File Type|Assignment 
:---|:---|:---|:---
9.10.22|Rmarkdown 1|.html|[Assignment 1](Assignments/Assignment1.html)
9.11.22|Rmarkdown 2|.html|[Assignment 2](Assignments/practice_lecture2.html)
